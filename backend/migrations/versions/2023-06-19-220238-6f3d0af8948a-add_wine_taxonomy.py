...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status_id", sa.Integer(), nullable=False, comment="Status id"
        ),
        sa.Column(
            "account_id",
            sa.BigInteger(),
        ...
        sa.Column(
            "floor", sa.String(length=50), nullable=True, comment="Floor"
        ),
        sa.Column(
            "number", sa.String(length=50), nullable=True, comment="Number"
        ),
        sa.Column(
            "postal_code",
            sa.String(length=50),
        ...
        sa.Column(
            "email", sa.String(length=50), nullable=True, comment="Email"
        ),
        sa.Column(
            "phone", sa.String(length=50), nullable=True, comment="Phone"
        ),
        sa.Column(
            "phone_secondary",
            sa.String(length=50),
    ...
    op.create_table(
        ...
        sa.Column(
            "user_id", sa.BigInteger(), nullable=False, comment="User id"
        ),
        sa.Column(
            "action",
            sa.String(length=10),
        ...
        sa.UniqueConstraint(
            "user_id", "action", "token", name="ad_user_action_token"
        ),
        mysql_charset="utf8mb4",
        mysql_collate="utf8mb4_general_ci",
        mysql_engine="InnoDB",
