...
from .resources import VerificationsUserResource

blueprint = Blueprint("verifications", __name__)
api = Api(blueprint)

# Verifications management
api.add_resource(
    VerificationsUserResource,
    "/verification/user/<string:user_id>/<string:token>",
    endpoint="verificationsuserresource",
)
