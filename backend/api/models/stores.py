...
class Store(db.Model, BaseModel, metaclass=MetaBaseModel):
    ...
    gps_latitude = db.Column(
        db.String(25), nullable=True, comment="GPS coordinates, latitude"
    )
    gps_longitude = db.Column(
        db.String(25), nullable=True, comment="GPS coordinates, longitude"
    )
    ...
    contact_phone_description = db.Column(
        db.String(50),
        nullable=True,
        comment="Phone description (e.g. call to land line)",
    )

    contact_phone_secondary = db.Column(
        db.String(50), nullable=True, comment="Secondary phone"
    )
    contact_phone_secondary_description = db.Column(
        db.String(50),
        nullable=True,
    ...
    social_facebook = db.Column(
        db.String(50), nullable=True, comment="Address for social network Facebook"
    )
    social_twitter = db.Column(
        db.String(50), nullable=True, comment="Address for social network Twitter"
    )
    social_instagram = db.Column(
        db.String(50), nullable=True, comment="Address for social network Instagram"
    )
    social_tiktok = db.Column(
        db.String(50), nullable=True, comment="Address for social network Tiktok"
    )
