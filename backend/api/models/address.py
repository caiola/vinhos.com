...
class Address(db.Model, BaseModel, metaclass=MetaBaseModel):
    ...
    designation = db.Column(db.String(50), nullable=True, comment="Designation is the internal name of the address")
    is_default_address = db.Column(db.Byte(), nullable=True, comment="Is default address e.g. 0=No; 1=Yes")
    ...
    person = db.Column(db.String(50), nullable=True, comment="Person responsible on this address")
