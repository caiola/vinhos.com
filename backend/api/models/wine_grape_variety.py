"""
Define the Wine Grape Variety model
"""
from . import db
...
class WineGrapeVariety(db.Model, BaseModel, metaclass=MetaBaseModel):
    """The Wine Grape Varieties model"""
    ...
    main_category_id = db.Column(db.BigInteger(), nullable=False, comment="Main category id")
